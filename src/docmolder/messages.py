WELCOME_MESSAGE = (
    "Ciao, sono DocMolder.\n\n"
    "Inviami immagini o PDF e ti aiuterò a trasformarli direttamente qui su Telegram.\n"
    "Per ora l'accesso è limitato agli utenti autorizzati."
)

UNAUTHORIZED_MESSAGE = (
    "Questo bot è riservato agli utenti autorizzati. "
    "Se pensi sia un errore, contatta l'amministratore di DocMolder."
)
