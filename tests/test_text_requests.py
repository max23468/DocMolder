...
class TextRequestParsingTest(unittest.TestCase):
    ...
    def test_quick_action_guidance_handles_empty_and_mismatched_sessions(self) -> None:
        ...
        self.assertIn("per pagina", _build_quick_action_guidance(None, "Dividi PDF"))
        self.assertIn("serve un PDF", _build_quick_action_guidance(image_session, "Dividi PDF"))
        self.assertIn("un solo PDF", _build_quick_action_guidance(multi_pdf_session, "Dividi PDF"))
