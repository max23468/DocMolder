...
PYTHON_VERSION="${DOCMOLDER_PYTHON_RUNTIME_VERSION:-3.13.13}"
PYTHON_SHA256="${DOCMOLDER_PYTHON_RUNTIME_SHA256:-2ab91ff401783ccca64f75d10c882e957bdfd60e2bf5a72f8421793729b78a71}"
