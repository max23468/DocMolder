...
| --- | --- | --- | --- | --- |
| in review | Codex current chat | codex/1-0-readiness / #103 | Readiness 1.0: criteri prodotto/ops, smoke plan, flusso release graduation, docs/test | PR #103 aperta per preparare la 1.0 senza bump immediato; resta da completare smoke Telegram funzionale prima del bump effettivo. |
