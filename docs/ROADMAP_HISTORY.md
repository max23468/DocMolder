# Archivio roadmap prodotto

Archivio storico della vecchia roadmap estesa. Non è la roadmap canonica:
priorità e prossimi passi correnti stanno in [`ROADMAP.md`](./ROADMAP.md).

Questo snapshot raccoglieva le priorità di `DocMolder` dopo la promozione alla
linea stabile `1.x`.
