...
## Stato attuale repo
- `DOPPLER_PROJECT` impostato a: `DocMolder`
...
```bash
gh variable set DOPPLER_PROJECT --body "DocMolder" --repo max23468/DocMolder
gh variable set DOPPLER_CONFIG --body "production" --repo max23468/DocMolder

gh secret set DOPPLER_TOKEN --body "<service_token_read_only>" --repo max23468/DocMolder
```
