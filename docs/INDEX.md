...
- [CODEX_CLOUD_DEPLOY.md](./CODEX_CLOUD_DEPLOY.md): flusso consigliato per lavorare da Codex web/cloud, con deploy manuale di default e webhook GitHub privato come automazione senza Actions.
