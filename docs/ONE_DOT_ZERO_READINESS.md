...
- processo release gestito da webhook VPS + procedura release manuale documentata
...
4. coordinare il target major nel flusso della procedura release manuale documentata prima del merge finale
