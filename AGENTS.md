...
- I commenti del Codex connector bot si gestiscono tramite la issue GitHub `Codex feedback inbox`, aggiornata dal workflow `.github/workflows/codex-pr-comments.yml`. Non usare più file Markdown/JSON committati o scansioni manuali ripetute di tutte le PR come inbox operativa.
