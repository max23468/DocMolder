...
- Quando l'utente chiede di "caricare" una modifica su GitHub, considera incluso l'intero flusso: branch/commit mirato, push, PR, monitoraggio check e merge appena i check richiesti sono verdi, salvo richiesta esplicita di fermarsi a push o PR. Dove possibile usa `scripts/publish_change.sh "<titolo conventional>"`.
