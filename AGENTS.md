...
- In modalita senza budget GitHub Actions, i workflow automatici restano spenti per default: usa gate locali, webhook VPS e release automatica VPS come percorso normale, e ricorri a `workflow_dispatch` solo se l'utente lo chiede esplicitamente.
